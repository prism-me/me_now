            ...
            success: function (data) {
                ...
                if (str.status == 1) {
                    ...
                    starCountRef1.once("value", (snapshot1) => {
                        ...
                        if (user == null) {
                            ...
                            if ($("#is_chat").val() == 1) {
                                $("#is_chat").val(0);
                                window.location.href =
                                    $("#siteurl").val() + "/chatarea";
                            } else {
                                window.location.href =
                                    $("#siteurl").val() + "/myaccount";
                            }
                        }
                    });
                } else {
                    ...
                    document.getElementById("login_error").innerHTML =
                        ...
                        str.data +
                        '<button type="button" style="background: none !important;" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true" style="float: inherit;">×</span></button></div>';
                }
            },
        });
    }
...
function PostRegister() {
    ...
    if (phone == "") {
        document.getElementById("reg_phone_error").innerHTML =
            $("#phonereq").val();
        temp = 1;
    }
    if (password == "") {
...
function Postforgot() {
    ...
    if (temp == 1) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == 1) {
                    document.getElementById("forgot_email_success").innerHTML =
                        $("#mailsend").val();
                } else {
                    document.getElementById("forgot_email_error").innerHTML =
                        $("#notfoundemail").val();
...
function ordernow(package_id) {
    window.location.href =
        $("#siteurl").url + "/subscription" + "/" + package_id;
}
