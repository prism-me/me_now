         ...
         <div class="col-md-9">
            <div class="card">
               <div class="card-body">
                  ...
                  @endif                              
                    <form action="{{ URL::to('admin/home-section') }}" method="POST" novalidate="novalidate"
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <textarea id="description" placeholder="{{__('messages.Enter').'  '.__('messages.Description')}}" class="form-control" required name="description" ></textarea>
                     </div>
