                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                              <form action="/{{Session::get('locale')}}/admin/update-room/{{  $data->slug }}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="excerpt" placeholder="Excerpt"
                                        ...
                                        value="{{ isset($data->excerpt) ? $data->excerpt : '' }}">{{$data->excerpt}}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" placeholder="Description 1"
                                        ...
                                        value="{{ isset($data->description) ? $data->description : '' }}">{{ $data->description}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="name" class=" form-control-label">
                                        {{ __('messages.Description') }}
                                    ...
                                    <textarea id="description1" placeholder="{{ __('messages.Enter') . '  ' . __('messages.Description 2') }}"
                                        ...
                                        value="{{ isset($data->description2) ? $data->description2 : '' }}">{{ $data->description2}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="name" class=" form-control-label">
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($data->more_img1)
                                        <img src="{{ $data->more_img1 }}" class="imgsize1 departmentimg" />
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($data->more_img2)
                                        <img src="{{ $data->more_img2 }}" class="imgsize1 departmentimg" />
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($data->featured_img2)
                                        <img src="{{ $data->featured_img2 }}" class="imgsize1 departmentimg" />
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($data->icons)
                                        <img src="{{ $data->icons }}" class="imgsize1 departmentimg" />
                                    @endif
