<div class="owl-carousel owl-theme banner-img">
    ...
    <div class="item"><img src="{{ asset('front/img/banner/banner-3.jpeg') }}" alt="banner images" />
        <div class="overlay"></div>
        <div class="caption">
    ...
    <div class="item"><img src="{{ asset('front/img/banner/banner-5.jpeg') }}" alt="banner images" />
        <div class="overlay"></div>
        <div class="caption">
