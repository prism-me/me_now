...
<?php if($setting->is_rtl==""||$setting->is_rtl=='1'): ?>
...
<input type="hidden" id="chatuserid" value="<?php echo e($chatuserid); ?>"/>
               ...
               <div class="chat-body">
                <div id="chat_1">
                    <div style="padding: 205px 290px;">
                         ...
                         ?>
                         <img src="<?php echo e($path); ?>" style="width: 100px;border-radius: 50px;">
...
<input type="hidden" id="currenttime"/>
    ...
    <input type="hidden" id="timezone" value="<?php echo e($timezone_name); ?>"/>
    ...
    <input type="hidden" id="currentprofileimage" value="<?php echo e(asset('public/upload/profile').'/'.Auth::user()->profile_pic); ?>">
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("front.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Menow\me_now\resources\views\front\chatarea.blade.php ENDPATH**/ ?>