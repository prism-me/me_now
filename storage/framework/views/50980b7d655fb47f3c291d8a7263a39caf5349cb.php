                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                              <form action="/<?php echo e(Session::get('locale')); ?>/admin/update-room/<?php echo e($data->slug); ?>" method="POST" novalidate="novalidate" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\me_now\resources\views/admin/room/save.blade.php ENDPATH**/ ?>