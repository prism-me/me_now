         ...
         <div class="col-md-9">
            <div class="card">
               <div class="card-body">
                  ...
                  <?php endif; ?>                              
                  <form action="<?php echo e(URL::to('admin/update-faq') . '/' . $data->slug); ?>" method="POST" novalidate="novalidate" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Menow\me_now\resources\views\admin\faq\save.blade.php ENDPATH**/ ?>