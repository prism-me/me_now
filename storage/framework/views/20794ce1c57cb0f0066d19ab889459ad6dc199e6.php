            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <li><a href="workshops"><?php echo e(__('messages.Workshop')); ?></a></li>
                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/<?php echo e(Session::get('locale')); ?>/admin/update-workshop/<?php echo e($data->slug); ?>" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" placeholder="<?php echo e(__('messages.Enter').'  '.__('messages.Event Type')); ?>" class="form-control" required name="event_type" value="<?php echo e(isset($data->event_type)?$data->event_type:''); ?>">
                                </div>
                                 <div class="form-group">
                                    <label for="name" class=" form-control-label">
                                    ...
                                    <select id="title" placeholder="<?php echo e(__('messages.Enter').'  '.__('messages.Doctor')); ?>" class="form-control" required name="doctor_id" >
                                        <?php $__currentLoopData = $doctor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($data->doctor_id == $value->id): ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" placeholder="<?php echo e(__('messages.Enter') . '  ' . __('messages.Short Description')); ?>"
                                        ...
                                        value="<?php echo e(isset($data->short_description) ? $data->short_description : ''); ?>"><?php echo e($data->short_description); ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="name" class=" form-control-label">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $__currentLoopData = $data->event_date; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event_date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\me_now\resources\views/admin/workshop/saveWorkshop.blade.php ENDPATH**/ ?>