                     ...
                     <div class="tab-pane fade <?= $tab_id == 1 ? 'show active' : "" ?> btnsaveoption" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <form action="<?php echo e(url('doctor/updatedoctorprofile')); ?>" method="post"  enctype="multipart/form-data">
                           ...
                           <div class=" col-md-12 form-group">
                              ...
                              <textarea id="description" name="aboutus" class="form-control"><?php echo e(isset($data->about_us)?$data->about_us:''); ?></textarea>
                           </div>
                           <div class="col-md-12 form-group">
                              <label for="email" class=" form-control-label">
                           ...
                           <div class="col-md-12 form-group">
                              ...
                              <?php if($doctor_id!=0): ?>
                              <img src="<?php echo e(asset('upload/doctor').'/'.$data->image); ?>" class="imgsize1 departmentimg" /> 
                              <?php endif; ?>
                              <div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('doctor.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Menow\me_now\resources\views\doctor\savedoctor.blade.php ENDPATH**/ ?>