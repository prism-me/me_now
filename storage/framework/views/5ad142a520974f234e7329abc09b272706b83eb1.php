         ...
         <div class="col-md-12">
            <div class="card">
               <div class="card-body">
                  ...
                  <?php endif; ?>
                  <div>
                     <a href="<?php echo e(URL::to('admin/faqs/create')); ?>" class="btn btn-primary"><?php echo e(__('messages.Add').' '.__('messages.Faq')); ?></a>
                  </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Menow\me_now\resources\views\admin\faq\default.blade.php ENDPATH**/ ?>