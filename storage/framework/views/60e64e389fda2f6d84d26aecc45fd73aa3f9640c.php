								  ...
								  <div class="col-lg-3 col-md-4 col-sm-6">
									<div class="department-part-box">
										...
										<div class="department-viewd-btn services-btn-main-box">
											<a href="<?php echo e(url('departmentdetail').'/'.$d->slug); ?>"><?php echo e(__('messages.View Detail')); ?></a>
										</div>
									</div>
								  </div>
								  <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Menow\me_now\resources\views\front\pricing.blade.php ENDPATH**/ ?>