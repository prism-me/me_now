        ...
        <div class="banner-img">
            ...
            <div class="workshop_inner_overlay" data-aos="fade-left">
                <div class="meta_content">
                    ...
                    <div class="meta1"><span class="fa fa-chevron-right"></span> <b><?php echo e(__('messages.Age')); ?>: </b>&nbsp;
                        Adults (18
                        Yrs+) </div>
                    <div class="meta1"><span class="fa fa-chevron-right"></span> <b><?php echo e(__('messages.Facilitated by')); ?>:
                        </b>
                    </div>
