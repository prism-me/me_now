      ...
      <div class="page-header float-right">
         <div class="page-title">
            <ol class="breadcrumb text-right">
               <li><a href="/<?php echo e(Session::get('locale')); ?>/admin/department"><?php echo e(__('messages.Department')); ?></a></li>
               <li><a href="/<?php echo e(Session::get('locale')); ?>/admin/departmentservice').'/'.$departmentservice"><?php echo e(__('messages.Department Service')); ?></a></li>
         ...
         <div class="col-md-9">
            <div class="card">
               <div class="card-body">
                  ...
                  <?php endif; ?>                              
                  <form action="/<?php echo e(Session::get('locale')); ?>/admin/updatedepartmentservice" method="post" novalidate="novalidate" enctype="multipart/form-data">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\me_now\resources\views/admin/department/addservice.blade.php ENDPATH**/ ?>