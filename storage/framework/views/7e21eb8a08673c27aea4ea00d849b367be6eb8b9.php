    ...
    <div class="workshop_wrapper">
        <div class="banner-img">
            ...
            <div class="workshop_inner_overlay" data-aos="fade-left">
                ...
                <span class="workshop-share"><b><?php echo e(__('messages.Share')); ?>:</b></span>
                <?php echo $social; ?>
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\me_now\resources\views/front/workshops_inner.blade.php ENDPATH**/ ?>