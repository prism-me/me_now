...
<?php echo e(__('messages.Save Home')); ?>
   ...
   <div class="col-sm-4">
      <div class="page-header float-left">
         <div class="page-title">
            <h1><?php echo e(__('messages.Save Home')); ?></h1>
         </div>
      </div>
   </div>
   <div class="col-sm-8">
      <div class="page-header float-right">
         <div class="page-title">
            <ol class="breadcrumb text-right">
               <li><a href="home-section"><?php echo e(__('messages.Home')); ?></a></li>
               <li class="active"><?php echo e(__('messages.Save Home')); ?></li>
            </ol>
         </div>
      </div>
   </div>
         ...
         <div class="col-md-9">
            <div class="card">
               <div class="card-body">
                  ...
                  <?php endif; ?>                              
                    <form action="/<?php echo e(Session::get('locale')); ?>/admin/update-home/<?php echo e($data->slug); ?>" method="POST" novalidate="novalidate"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\me_now\resources\views/admin/home/save.blade.php ENDPATH**/ ?>