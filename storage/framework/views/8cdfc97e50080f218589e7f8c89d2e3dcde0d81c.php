      ...
      <div class="page-header float-right">
         <div class="page-title">
            <ol class="breadcrumb text-right">
               <li><a href="<?php echo e(url('admin/about')); ?>"><?php echo e(__('messages.Home')); ?></a></li>
         ...
         <div class="col-md-9">
            <div class="card">
               <div class="card-body">
                  ...
                  <?php endif; ?>                              
                    <form action="<?php echo e(URL::to('admin/update-home'.'/'.$data->slug)); ?>" method="POST" novalidate="novalidate"
