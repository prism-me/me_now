         ...
         <div class="col-md-9">
            <div class="card">
               <div class="card-body">
                  ...
                  <?php endif; ?>                              
                  <form action="/<?php echo e(Session::get('locale')); ?>/admin/updatedepartment" method="post" novalidate="novalidate" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        ...
                        <?php if($department_id!=0): ?>
                        <img src="<?php echo e($data->banner_image); ?>" class="imgsize1 departmentimg" style="width:50px;height:50px;"/> 
                        <?php endif; ?>
                        <div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\me_now\resources\views/admin/department/savedepartment.blade.php ENDPATH**/ ?>