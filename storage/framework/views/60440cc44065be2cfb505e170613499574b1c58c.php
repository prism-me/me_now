                  ...
                  <table id="service" class="table  table-striped table-bordered">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="group">
                                <a href="<?php echo e(url('admin/savedepartment/').'/'.$d->id); ?>" > <i class='fa fa-pencil fa-lg' aria-hidden="true"> </i> </a>
                              </div>
                              <div class="group">
                                <a href="<?php echo e(url('admin/departmentservice/').'/'.$d->id); ?>" > <i class='fa fa-plus-circle fa-lg' aria-hidden="true"> </i> </a>
                              </div>
                              <div class="group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877734042/domains/menow.ae/public_html/resources/views/admin/department/default.blade.php ENDPATH**/ ?>