      ...
      <div class="page-header float-right">
         <div class="page-title">
            <ol class="breadcrumb text-right">
               <li><a href="women"><?php echo e(__('messages.About Us')); ?></a></li>
         ...
         <div class="col-md-9">
            <div class="card">
               <div class="card-body">
                  ...
                  <?php endif; ?>                              
                    <form action="/<?php echo e(Session::get('locale')); ?>/admin/update-women/<?php echo e($data->slug); ?>" method="POST" novalidate="novalidate"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\me_now\resources\views/admin/women/save.blade.php ENDPATH**/ ?>