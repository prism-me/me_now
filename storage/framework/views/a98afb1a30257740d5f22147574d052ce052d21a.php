        ...
        <div class="row">
            <div class="col-md-7">
                <div class="about_content" >
                    <img src="<?php echo e(asset('front/img/logo-background.png')); ?>" alt="logo" class="about-section-logo">
                    <h2 class="animated fadeInDown delay-2s">About Me Now</h2>
                    <p class="animated fadeInDown"> With the goal of de-stigmatizing mental illness and providing patients with a variety of
...
<?php /**PATH D:\Projects\Menow\me_now\resources\views/front/about_section.blade.php ENDPATH**/ ?>