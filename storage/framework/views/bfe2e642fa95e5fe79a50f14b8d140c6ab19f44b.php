                                    ...
                                    <div class="doctorl-part-box">
                                        ...
                                        <div class="doctorl-part-detail text-center">
                                            ...
                                            <p style="color:rgb(108, 108, 108)">
                                                <?php echo e(substr($d->about_us, 0, 100)); ?>... <a href="<?php echo e(url('doctordetails/') . '/' . $d->slug); ?>">Read More</a>
        ...
        <div class="promo_section">
            <div class="container">
                <div class="row" style="align-items: center;">
                    ...
                    <div class="col-md-3">
                        <button class="btn btn-primary get-in-touch-button"  data-toggle="modal" data-target="#appointmentModal">Consult with us</button>
                    </div>
                </div>
            </div>
        </div>
