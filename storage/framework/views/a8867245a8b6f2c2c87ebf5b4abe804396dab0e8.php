         ...
         <div class="col-md-9">
            <div class="card">
               <div class="card-body">
                  ...
                  <?php endif; ?>                              
                  <form action="<?php echo e(URL::to('admin/blogs')); ?>" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        ...
                        <?php if($data->featured_img): ?>
                              <img src="<?php echo e($data->featured_img); ?>" class="imgsize1 btndepartwarning" /> 
                              <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Menow\me_now\resources\views\admin\blog\addBlog.blade.php ENDPATH**/ ?>