                  ...
                  <form action="<?php echo e(URL::to('admin/rooms')); ?>" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <textarea id="excerpt" placeholder="<?php echo e(__('messages.Enter').'  '.__('messages.Excerpt')); ?>" class="form-control" required name="excerpt" value="<?php echo e(isset($data->excerpt)?$data->excerpt:''); ?>"></textarea>
                    </div>
                     <div class="form-group">
                        <label for="name" class=" form-control-label">
                     ...
                     <div class="form-group">
                        <label for="name" class=" form-control-label">
                        <?php echo e(__('messages.Addtional Content-1')); ?>

                        <span class="reqfield">*</span>
                        </label>
                        <textarea id="description" placeholder="<?php echo e(__('messages.Enter').'  '.__('messages.Addtional Content-1')); ?>" class="form-control" required name="additional_content_1" value="<?php echo e(isset($data->additional_content_1)?$data->additional_content_1:''); ?>"></textarea>
                     </div>
