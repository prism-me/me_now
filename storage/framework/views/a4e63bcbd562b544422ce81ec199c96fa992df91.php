         ...
         <div class="col-md-12">
            <div class="card">
               <div class="card-body">
                  ...
                  <?php endif; ?>
                  <div>
                     <a href="add-women" class="btn btn-primary"><?php echo e(__('messages.Add').' '.__('messages.Women Empowerment')); ?></a>
                  </div>
                  ...
                  <table id="service" class="table  table-striped table-bordered">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="group">
                                <a href="edit-women/<?php echo e($d->slug); ?>" > <i class='fa fa-pencil fa-lg' aria-hidden="true"> </i> </a>
                              </div>
