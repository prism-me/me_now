                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6" data-aos="fade-up">
                                <div class="d-detail-collapse-doctor">
                                    <div class="doctorl-part-box workshops-wrapper">
                                        <a href="<?php echo e(route('workshop.details',[Session::get('locale'),$d->slug])); ?>" class="denone box-container">
                                            <img src="<?php echo e($d->featured_img); ?>" class="img-fluid">
                                        </a>

                                        <div class="workshop-part-detail">
                                            <h4><a
                                                    href="<?php echo e(route('workshop.details',[Session::get('locale'),$d->slug])); ?>"><?php echo e(ucwords($d->title)); ?></a>
                                            </h4>
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\me_now\resources\views/front/workshop.blade.php ENDPATH**/ ?>