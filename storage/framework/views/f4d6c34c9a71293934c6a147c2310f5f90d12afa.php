               ...
               <div class="card-body">
                  ...
                  <form action="<?php echo e(URL::to('admin/update-room').'/' . $data->slug); ?>" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="excerpt" placeholder="<?php echo e(__('messages.Enter').'  '.__('messages.Excerpt')); ?>" class="form-control" required name="excerpt" value="<?php echo e(isset($data->excerpt)?$data->excerpt:''); ?>"><?php echo e($data->excerpt); ?></textarea>
                    </div>
                    <div class="form-group">
                       <label for="name" class=" form-control-label">
                     ...
                     <div class="form-group">
                        <label for="name" class=" form-control-label">
                        <?php echo e(__('messages.Addtional Content')); ?>
                    ...
                    <div>
                     <div class="form-group">
                        ...
                        <?php $__currentLoopData = $data->slider_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Menow\me_now\resources\views\admin\room\save.blade.php ENDPATH**/ ?>