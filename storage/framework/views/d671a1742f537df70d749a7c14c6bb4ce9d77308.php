            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <?php endif; ?>                              
                     ...
                     <div class="form-group">
                        <label for="file" class=" form-control-label">  
                        <img src="<?php echo e(isset($data->thumbnail_img)?$data->thumbnail_img:''); ?>" class="imgsize1 departmentimg" style="width:50px;height:50px;"/> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Menow\me_now\resources\views\admin\events\show.blade.php ENDPATH**/ ?>