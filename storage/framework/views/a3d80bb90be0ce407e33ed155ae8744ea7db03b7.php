                  ...
                  <div class="tab-content pl-3 p-1" id="myTabContent">
                        <form action="/<?php echo e(Session::get('locale')); ?>/admin/updatedoctorprofile" method="post"  enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                              <div class="col-md-6"> 
                                 <label for="name" class=" form-control-label">
                                 <?php echo e(__('messages.Doctor Designation')); ?>

                                 <span class="reqfield" >*</span>
                                 </label>
                                 <input type="text" id="name" placeholder="<?php echo e(__('messages.Enter').' '.__('messages.Doctor designation')); ?>" class="form-control"  name="designation" value="<?php echo e(isset($data->designation)?$data->designation:''); ?>">
                              </div>
                              <div class="col-md-6">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\me_now\resources\views/admin/doctor/savedoctor.blade.php ENDPATH**/ ?>