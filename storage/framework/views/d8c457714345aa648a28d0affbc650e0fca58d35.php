         ...
         <div class="col-md-9">
            <div class="card">
               <div class="card-body">
                  ...
                  <form action="<?php echo e(URL::to('admin/update-workshop').'/'.$data->slug); ?>" method="post" novalidate="novalidate" enctype="multipart/form-data">
                     <?php echo csrf_field(); ?>
                     ...
                     <div class="form-group">
                        ...
                        <input id="start_date" name="event_date" type="text" class="form-control" required value="<?php echo e(isset($event_date)&&$event_date!=0?$event_date:""); ?>">
                     </div>
                     <div class="form-group">
                        <label for="name" class=" form-control-label">
