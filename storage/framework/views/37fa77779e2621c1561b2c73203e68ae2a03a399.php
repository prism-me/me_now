      ...
      <div class="page-header float-right">
         <div class="page-title">
            <ol class="breadcrumb text-right">
               <li><form action="/<?php echo e(Session::get('locale')); ?>/admin/workshops"><?php echo e(__('messages.Workshop')); ?></a></li>
         ...
         <div class="col-md-9">
            <div class="card">
               <div class="card-body">
                  ...
                  <?php endif; ?>                              
                  <form action="<?php echo e(URL::to('admin/workshops')); ?>" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" id="price" placeholder="<?php echo e(__('messages.Enter').'  '.__('messages.Price')); ?>" class="form-control" required name="price" value="<?php echo e(isset($data->price)?$data->price:''); ?>">
                     </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\me_now\resources\views/admin/workshop/addWorkshop.blade.php ENDPATH**/ ?>