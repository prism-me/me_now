        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse admin-main-menu">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="<?php echo e(url('admin/dashboard')); ?>"> <i
                    ...
                    <li class="active">
                        <a href="<?php echo e(url('admin/doctor')); ?>"> <i
...
<?php /**PATH /home/u877734042/domains/menow.ae/public_html/resources/views/admin/layout.blade.php ENDPATH**/ ?>